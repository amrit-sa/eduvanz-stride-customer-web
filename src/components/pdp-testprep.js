...
import { getCompareProducts, getFavoriteProductCount, getTestimonial } from "../actions/product";
...
class PdpTestPrep extends Component {
    ...
    async componentDidMount() {
        ...
        this.props.dispatch(getTestimonial({ "sfid": product.sfid, "is_alumni": false })).then((response) => {
            if (response && response.data) {
                console.log('blog', response.data)
                this.setState({ relatedBlogData: response.data });
            }
        });
    ...
    render() {
        ...
        return (
            <>
                                        ...
                                        <div className="d-flex cf_box">
                                            ...
                                            <div className="duration">No Cost EMI Starting
                                                <div className="d-flex">
                                                    ...
                                                    <button className="link" onClick={() => { this.setState({ morePlansOpen: true }) }}>View Plans</button>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div className="col-12">
                                    ...
                                    <div className="col">
                                        <div className="p-4  about_course">
                                            ...
                                            <ul className='list-style-circle'>
                                                <li>The Masters in CFD program is a 12 month long, intensive program.
                                                    The program comprises of 6 courses that train you on all the
                                                    essential engineering concepts and tools that are essential to get
                                                    into top OEMs. as a CFD Engineer.
                                                </li>
                                            </ul>
                            ...
                            <div id="whatYoullLearn">
                                <div className="my-4 ">
                                    ...
                                    <div className="row mx-0">
                                        <div className="col-sm-6">
                                            <p>This beginner-level, six-course certificate, professionals with in-demand
                                                skills -and training -- that can help you advance your career.
                                            </p>
                                            ...
                                            <ul className="course-list mb-0">
                                                <li className="d-flex flex-wrap align-items-center">
                                                    <div className="mr-3 img-box">
                                                        <img src={`${asset}images/wu01.png`} alt=""
                                                            className="img-fluid" />
                                                    </div>
                                                    <div>
                                                ...
                                                <li className="d-flex flex-wrap align-items-center">
                                                    <div className="mr-3 img-box">
                                                        <img src={`${asset}images/wu02.png`} alt=""
                                                            className="img-fluid" />
                                                    </div>
                                                    <div>
                ...
                <PaymentPlan onClose={() => { this.setState({ morePlansOpen: !this.state.morePlansOpen }) }} product_sfid={product} isOpen={this.state.morePlansOpen} />
...
export default reduxForm({ form: 'PDP-Educa' })(PdpTestPrep);