...
class VirtualCard6 extends Component {
    ...
    render() {
        const { isLoading, banks, user,sfid,username,isSearching,searchDet,favorite_count } = this.props
                   ...
                   <div className='row'>
                       <div className='col-sm-12'>
                           <div className='d-flex align-items-center'>
                               <button onClick={this.handleBack} type='button' className='back-btn rounded-circle mr-3 mr-lg-4'>
                                   back
                               </button>
...
function mapStateToProps(state) {
    ...
    const { salesForceToken, user, isLoading, sfid ,username} = state.auth;
    ...
    return {
        ...
        sfid,
        user,
        isLoading,isSearching, searchDet, favorite_count,username
    };
}
