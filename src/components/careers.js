                    ...
                    <div class="container">
                        <div class="row" style={{ paddingTop: '100px', paddingBottom: "100px" }}>
                            ...
                            <div class="col-lg-6 col-md-6" style={{ paddingTop: '40px' }}>
                                <div className=' mt-5'>
                                    <p className=' mb-5' style={{ fontWight: "300", fontSize: "30px" }}>The Eduvanz Story</p>
                                    <h6 className='mt-2 mb-4'>EDUCATION SHOULDN'T BE A PRIVILEGE, IT SHOULD BE A RIGHT.</h6>
                                    <p>Eduvanz believes in making education accessible for all.

                                        Join us if your aim aligns with ours!</p>

                                    <div className='footerlink mt-5'>
                                        <a style={{background:"#0099CC",padding:'20px',color:"white"}} href='https://eduvanz.com/career'> View Openings</a>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6" align="center">
                                ...
                                <img className='img-responsive story-img' src="https://d1idiaqkpcnv43.cloudfront.net/assets/webimages/hiring.png" height="450" width="500" />
                            </div>
                        </div>
                    </div>
                </div>
