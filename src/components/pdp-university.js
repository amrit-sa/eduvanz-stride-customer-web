...
class PdpUniversity extends Component {
    ...
    handleSubmit = (e)=>{
        ...
        // this.props.history.push('/edplans?product='+this.props.product.sfid)
    }
                        ...
                        <div className="col">
                            <div className="">
                                <ul className="d-flex cf_box_wrap">
                                    ...
                                    <li className='apply-flex wishlist'>
                        ...
                        <div className="col-12">
                            ...
                            <div id="whatYoullLearn">
                                <div className="my-4 ">
                                    ...
                                    <div className="row mx-0">
                                        {product && product.syllabus__c &&
                                            <>
                                                <div className="col-sm-6">
                                                    <p>{
                                                        product.syllabus__c.description
                                                    }</p>
...
export default reduxForm({ form: 'PDP-Educa' })(PdpUniversity);