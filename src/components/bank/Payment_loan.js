...
class Payment_loan extends Component {
    ...
    render() {
        ...
        const { isLoading, banks, user , collection ,history} = this.props
                        ...
                        <div className='row'>
                            <div className='col-sm-12'>
                                <div className='d-flex align-items-center'>
                                    <button onClick={() => this.props.goBack()} type='button' className='back-btn rounded-circle mr-3 mr-lg-4'>
                                        back
                                    </button>
                                ...
                                <div className='w-100 l-a-r'>
                                    <div className='row align-items-center'>
                                        <div className='col-lg-3'>
                                            <h4 className='total-loan-amount m-0'>Amount: <i className='rupee'>`</i>{this.props.paying_amount ? this.props.paying_amount.toLocaleString('en-IN') : '0' }</h4>
                                        </div>
...
export default connect(mapStateToProps)(Payment_loan)