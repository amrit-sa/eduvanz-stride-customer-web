...
class ProductLaptop20000 extends React.Component {
        ...
        this.props.getProductByCategoryData(5).then((response) => {
            if (response && response.status === "success") {
                ...
                for(let i=0;i<response.data.length;i++){
                    ...
                    if(response.data[i].price__c<=20000){
                ...
                <section className="pt-lg-5 pb-lg-3 overflow-hidden laptop-catgory-block">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-2 shopby-after-bg-image position-rel"><h3 className="section_title mb-lg-4 mb-3">Laptops under 20,000</h3><a href="#" className="text-decoration-none fs-14 font-weight-bold d-block">View All <i className="ml-2 fa fa-angle-right fs-14 font-weight-bold" aria-hidden="true"></i></a></div>
...
export default ProductLaptop20000;