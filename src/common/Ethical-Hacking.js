...
class Ehicalhacking extends React.Component {
            ...
            this.setState({ mba_date: response.data }
                ,()=>{
                    for(let i=0;i<this.state.mba_date.brandsubproduct?.length;i++){
                        ...
                        if(this.state.mba_date.brandsubproduct[i].title== "Ethical Hacking"){
                ...
                <section className="bg0 pt-lg-3 pb-lg-3 overflow-hidden upskill-block">
                    <div className="container">
                        <div className="row">
                            ...
                            <h3 className="section_title mb-lg-4 mb-3">Ethical Hacking</h3>
