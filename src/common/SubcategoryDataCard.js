...
class SubcategoryDataCard extends React.Component {
    ...
    componentDidMount() {
        ...
        this.setState({ lap_products: productList })
    }
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col mb-2 laptops">
                                <div className="d-flex justify-content-between align-items-center mb-2 shopby-after-bg-image position-rel"><h3 className="section_title mb-lg-4 mb-3">{this.props.category}</h3>
                                    <a href={`products-list?category=${this.props.category}`} className="text-decoration-none fs-14 font-weight-bold d-block">View All <i className="ml-2 fa fa-angle-right fs-14 font-weight-bold" aria-hidden="true"></i></a>
                                </div>
