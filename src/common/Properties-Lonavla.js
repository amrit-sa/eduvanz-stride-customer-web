...
class ProertiesLonavla extends React.Component {
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col mb-2">
                                <h3 className="section_title mb-lg-4 mb-3">Properties in Lonavla</h3>
                            </div>
                        </div>
                        <div className="row">
...
ProertiesLonavla.propTypes = {
    ...propTypes,
    pushPage: PropTypes.func,
    user: PropTypes.any
}

export default reduxForm({ form: 'header' })(ProertiesLonavla);