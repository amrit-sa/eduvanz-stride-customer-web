...
import $ from 'jquery';
import { getProductByCategory, favProduct, getEductionBrandLanding } from "../actions/user";
...
class Brand_listing_bar extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getEductionBrandLanding()).then((response) => {
                ...
                this.setState({ mba_date: response.data }
                    , () => {
                        for (let i = 0; i < this.state.mba_date.brandsubproduct?.length; i++) {
                            ...
                            if (this.state.mba_date.brandsubproduct[i].title.toUpperCase() == this.props.name.toUpperCase()) {

                                this.setState({ upskills_data: this.state.mba_date.brandsubproduct[i].data })
                        ...
                        <div className="row">
                            <div className="col mb-2 upskilling">
                                <div className="d-flex justify-content-between align-items-center mb-2 shopby-after-bg-image position-rel">
                                    <h3 className="section_title mb-lg-4 mb-3">{this.props.name}</h3>
...
export default Brand_listing_bar;