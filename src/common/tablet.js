                ...
                <section className="bg0 pt-lg-3 pb-lg-3 overflow-hidden tablet-deal-block">
                    <div className="container">
                        <div className="row">
                            ...
                            <h3 className="section_title mb-lg-4 mb-3">Smart Wearables</h3>
                               <a href="products-list?category=Smart Watch" className="text-decoration-none fs-14 font-weight-bold d-block">View All 
