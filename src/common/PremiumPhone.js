...
class PremiumPhone extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            mob_products: [],
                ...
                this.setState({ mba_date: response.data }
                    , () => {
                        ...
                        for (let i = 0; i < this.state.mba_date.brandsubproduct?.length; i++) {
                            ...
                            if (this.state.mba_date.brandsubproduct[i].title == "Smart Watch") {
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col mb-2 mobiles">
                                    <div className="d-flex justify-content-between align-items-center mb-2 shopby-after-bg-image position-rel"><h3 className="section_title mb-lg-4 mb-3">SmartWatch</h3><a href="#" className="text-decoration-none fs-14 font-weight-bold d-block">View All <i className="ml-2 fa fa-angle-right fs-14 font-weight-bold" aria-hidden="true"></i></a></div>
